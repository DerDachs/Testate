 ...
 * @author dachs
 */
public class zutatAnlegenDialog extends javax.swing.JDialog {
    ...
    /**
     * Creates new form zutatAnlegenDialog
     */
    public zutatAnlegenDialog(MainFrame mainFrame, boolean modal) {
    ...
    private void initComponents() {
        ...
        grundzutRadioBtn = new javax.swing.JRadioButton();
        geschmackszutRadioBtn = new javax.swing.JRadioButton();
        dekozutRadioBtn = new javax.swing.JRadioButton();
        ...
        bezPanel.setPreferredSize(new java.awt.Dimension(500, 200));
        ...
        parentPanel.add(bezPanel, "card6");

        preisPanel.setPreferredSize(new java.awt.Dimension(500, 200));

        preisLabel.setText("Wie teuer ist die Zutat?");
        ...
        parentPanel.add(preisPanel, "card7");

        klassenPanel.setPreferredSize(new java.awt.Dimension(500, 200));

        grundzutRadioBtn.setSelected(true);
        grundzutRadioBtn.setText("Grundzutat");
        grundzutRadioBtn.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                grundzutRadioBtnItemStateChanged(evt);
            }
        });

        geschmackszutRadioBtn.setText("Geschmackszutat");
        geschmackszutRadioBtn.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                geschmackszutRadioBtnItemStateChanged(evt);
            }
        });

        dekozutRadioBtn.setText("Dekozutat");
        dekozutRadioBtn.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
                dekozutRadioBtnStateChanged(evt);
            }
        });

        klassenLabel.setText("Zu welcher Klasse gehört die Zutat?");
            ...
            .addGroup(klassenPanelLayout.createSequentialGroup()
                ...
                .addGroup(klassenPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(klassenPanelLayout.createSequentialGroup()
                        .addGroup(klassenPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(klassenPanelLayout.createSequentialGroup()
                                .addComponent(grundzutRadioBtn)
                                .addGap(18, 18, 18)
                                .addComponent(geschmackszutRadioBtn)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(dekozutRadioBtn))
        ...
        parentPanel.add(klassenPanel, "card8");

        getContentPane().add(parentPanel, java.awt.BorderLayout.CENTER);

        jLabel1.setText("Neue Zutat anlegen");
    ...
    private void grundzutRadioBtnItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_grundzutRadioBtnItemStateChanged
        if (grundzutRadioBtn.isSelected() == true) {
            klasse = 1;
        }
    }//GEN-LAST:event_grundzutRadioBtnItemStateChanged

    private void geschmackszutRadioBtnItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_geschmackszutRadioBtnItemStateChanged
        if (geschmackszutRadioBtn.isSelected() == true) {
            klasse = 2;
        }
    }//GEN-LAST:event_geschmackszutRadioBtnItemStateChanged

    private void dekozutRadioBtnStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_dekozutRadioBtnStateChanged
        if (dekozutRadioBtn.isSelected() == true) {
            klasse = 3;
        }
    }//GEN-LAST:event_dekozutRadioBtnStateChanged
    ...
    private void finishBtnKlasseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_finishBtnKlasseActionPerformed
        ...
        ZutatenController.zutatAnlegen(bezeichnung, preis, klasse);
    ...
    private javax.swing.JRadioButton dekozutRadioBtn;
    private javax.swing.JButton finishBtnKlasse;
    private javax.swing.JRadioButton geschmackszutRadioBtn;
    private javax.swing.JRadioButton grundzutRadioBtn;
